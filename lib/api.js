 ...
 * (2026-09-19: 28,356 curated passages + 758,543 record).
...
export const INDEX_CURATED = [
  ...
  "Nostr NIPs, Stratum V2, BLIPs, LNURL, LSP",
  "BDK, HWI, LDK, LND/CLN, Sparrow docs",
...
export const PLANS = [
  {
    ...
    includes: [
      "Full ~759k record passages + ~28k curated passages",
      "IRC, mailing lists, GitHub, forums, source; articles, whitepapers, academic papers, NIPs, Sparrow, select open-source books",
      "Argument assessment",
