...
export const DEFAULT_DESCRIPTION =
  "Cited search over Bitcoin’s public coordination record. Lightning. Model Context Protocol (MCP). BLVM is the node.";
...
const PAGES = {
  ...
  "/intelligence": {
    ...
    description:
      "Cited search over Bitcoin’s public coordination record. Lightning. Model Context Protocol (MCP).",
  },
  "/docs": {
    title: "Intelligence docs · BTCDecoded",
    description:
      "Connect to BTCDecoded Intelligence over Model Context Protocol (MCP): tools, Bearer keys, GitHub App.",
  },
  "/pricing": {
  ...
  "/terms": {
    title: "Terms · BTCDecoded",
    description:
      "Terms for BTCDecoded Intelligence: Lightning plans, accounts, and the MCP connector.",
  },
  "/privacy": {
    title: "Privacy · BTCDecoded",
    description:
      "Privacy policy for BTCDecoded Intelligence and the GitHub App.",
  },
  "/third-party": {
    title: "Third-party services · BTCDecoded",
    description:
      "Third-party services used by BTCDecoded Intelligence and the GitHub App.",
  },
  "/security": {
    title: "Security · BTCDecoded",
    description:
      "Security and safety of the BTCDecoded Intelligence GitHub App: no merge verdicts, live-only private review.",
  },
};
