        ...
        <div class="footer-content">
          <div class="footer-social">
            ...
            <div class="social-links">
              <a
                href="https://x.com/DecodeBitcoin"
                target="_blank"
                rel="noopener"
                class="social-link"
              >
                ...
                <span>@DecodeBitcoin</span>
              </a>
              <a
                href="https://github.com/BTCDecoded"
                target="_blank"
                rel="noopener"
                class="social-link"
              >
          ...
          <div class="footer-framework">
            <h4>Built on</h4>
            <p>
              <a href="https://thebitcoincommons.org" target="_blank"
                >Bitcoin Commons</a
              >
          ...
          <div class="footer-legal">
            ...
            <p>
              <a
                href="https://github.com/BTCDecoded/website/blob/main/LICENSE"
                target="_blank"
                rel="noopener"
                >MIT License</a
              >
