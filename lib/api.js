 ...
 * 11,904 curated + 683,718 record (IRC 370,901 + Bitcointalk 158,917).
 */
export const CORPUS = {
  curated: "~12,000",
  curatedShort: "~12k",
...
export const INDEX_CURATED = [
  ...
  "Open textbooks (CC): Learning Bitcoin CLI, Karasavvas, minium, Elementary Bitcoin, Dorier C#, Book of Bitcoin commentary, Mastering Bitcoin 2e, Mastering LN, BOLTs, Taproot, bitcoin.org docs, Optech",
