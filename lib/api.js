 ...
 * (2026-09-17: 24,181 curated passages + 758,543 record).
 * Academic papers: 876 keep works / 828 unique docs / 4,699 chunks.
 * IRC 370,901 + GitHub 165,218 + Bitcointalk 158,917.
 */
export const CORPUS = {
  curated: "~24,000",
  curatedShort: "~24k",
...
export const PLANS = [
  {
    ...
    includes: [
      "Full ~759k record passages + ~24k curated passages",
      "IRC, mailing lists, GitHub, forums, source; articles, whitepapers, academic papers, select open-source books",
      "Argument assessment",
  ...
  },
  {
    id: "developer",
    label: "Developer",
    blurb: "The record, plus public GitHub PR review.",
    includes: [
      "Everything in Researcher",
      "analyze_pr on public GitHub PRs (4000-char patch pack; private repos fail; 10 queries each)",
      "Cited retrieval: discourse, precedent, incidents, spec↔source (not a complete history)",
      "PR review markdown, not a GitHub comment",
      "500 queries per day",
    ],
    featured: true,
    options: [
