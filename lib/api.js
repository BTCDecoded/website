...
/**
 * Intelligence marketing counts from ingest:
 * 19,483 curated + 683,718 record (IRC 370,901 + Bitcointalk 158,917).
 */
export const CORPUS = {
  curated: "~19,000",
  curatedShort: "~19k",
...
export const PLANS = [
  {
    ...
    includes: [
      "Full ~684k record + curated ~19k",
      "IRC, mailing lists, GitHub, forums, source; articles, whitepapers, select open-source books",
      "Argument assessment",
  ...
  },
  {
    ...
    includes: [
      ...
      "analyze_pr on allowlisted public PRs (Bitcoin Core)",
      "PR review markdown",
      "500 queries per day",
    ],
    featured: true,
